...
ifeq ($(NEWS_MODEL), )
OPENNE_MODEL=-DkMachineModel="\"OpenNE\""
endif
...
FLAG_ASM=-f win64
FLAG_GNU=-fshort-wchar -c -ffreestanding -MMD -mno-red-zone -D__OPENNE_ARM64__ -fno-rtti -fno-exceptions -I./ \
			 -target aarch64-unknown-windows \
				-std=c++20 -DBOOTZ_EPM_SUPPORT -DkExpectedWidth=320 -DkExpectedHeight=480 -D__FSKIT_USE_NEFS__ -D__BOOTLDR_STANDALONE__ -D__OPENNE__ -D__OPENBOOTZ__ -D__HAVE_OPENNE_APIS__ -D__OPENNE__ -I../ -I../Kernel
				-std=c++20 -DBOOTZ_EPM_SUPPORT -DkExpectedWidth=320 -DkExpectedHeight=480 -D__FSKIT_USE_NEFS__ -D__BOOTLDR_STANDALONE__ -D__OPENNE__ -D__ZBAOSLDR__ -D__HAVE_OPENNE_APIS__ -D__OPENNE__ -I../ -I../Kernel

BOOT_LOADER=openbootz.exe
KERNEL=openne.exe
